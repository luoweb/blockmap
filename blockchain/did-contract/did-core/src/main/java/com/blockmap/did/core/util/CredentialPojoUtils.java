...
import com.blockmap.did.core.constant.CredentialConstant.CredentialProofType;
...
import static com.blockmap.did.core.service.impl.CredentialPojoServiceImpl.generateSalt;
...
public final class CredentialPojoUtils {
    ...
    public static boolean isSelectivelyDisclosed(Map<String, Object> saltMap) {
        ...
        for (Map.Entry<String, Object> entry : saltMap.entrySet()) {
            ...
            if (v == null) {
                throw new DidBaseException(ErrorCode.CREDENTIAL_SALT_ILLEGAL);
            }
    ...
    private static ErrorCode isCredentialProofValid(Map<String, Object> proof) {
        ...
        if (proof.get(ParamKeyConstant.PROOF_CREATOR) == null) {
            ...
            //if (!StringUtils.isEmpty(creator) && !DidUtils.isDidValid(creator)) {
