...
import com.blockmap.did.core.exception.ProtocolSuiteException;
...
public abstract class QrCodeBaseData {
    ...
    protected void buildBuffer(String[] protocols) {
        ...
        try {
            ...
            | SecurityException e) {
            throw new DidBaseException("buildBuffer error.", e);
        }
    }
    ...
    protected void buildData(String[] protocols, String transString) {
        ...
        try {
            ...
            | SecurityException e) {
            throw new DidBaseException("buildData error.", e);
        } 
    }
