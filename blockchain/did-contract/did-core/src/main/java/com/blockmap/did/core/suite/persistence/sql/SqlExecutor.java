...
public class SqlExecutor {
     ...
     * sql for query all.
     */
    public static final String SQL_QUERY_ALL = "select id,data,created,expire from $1 where ext3 = ? order by created";

    /**
     * sql for save.
     */
    public static final String SQL_SAVE = "insert into $1(id, data, expire, ext3) values(?,?,?,?)";
     ...
     * @return 返回查询出来的数据列表
     */
    public ResponseData<List<Map<String, String>>> executeQuery2(String sql, Object... data) {
        ...
        try {
            ...
            if (conn == null) {
                return
                        new ResponseData<List<Map<String, String>>>(
                                null,
                                ErrorCode.SQL_GET_CONNECTION_ERROR
                        );
            }
