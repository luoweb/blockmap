...
public interface AuthorityIssuerService {
     ...
     *
     * <p>The input argument actually includes: Didentity DID, Name, CreateDate, and Accumulator
    ...
    /**
     * Check whether the given Didentity DID is an authority issuer, or not.
     *
     * @param weId the Didentity DID
     * @return true if yes, false otherwise
     */
    ResponseData<Boolean> isAuthorityIssuer(String weId);

    /**
     * Query the authority issuer information from a given Didentity DID.
     *
     * @param weId the Didentity DID
     ...
     * @return Execution result
     */
    ResponseData<Boolean> registerIssuerType(DidAuthentication callerAuth, String issuerType);
     ...
     * @param callerAuth the caller who have the access to modify this list
     * @param issuerType the specified issuer type
     * @param targetIssuerDid the weId of the issuer to be removed from a specific issuer list
     * @return Execution result
     */
