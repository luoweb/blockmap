...
import com.icbc.did.core.protocol.base.*;
import com.icbc.did.core.protocol.request.CptStringArgs;
import com.icbc.did.core.protocol.request.RegisterAuthorityIssuerArgs;
...
import com.icbc.did.core.service.AuthorityIssuerService;
import com.icbc.did.core.service.CptService;
import com.icbc.did.core.service.DidService;
import com.icbc.did.core.service.impl.AuthorityIssuerServiceImpl;
import com.icbc.did.core.service.impl.CptServiceImpl;
    ...
    public HttpResponseData<Object> createDidInvoke(InputArg createDidJsonArgs) {
        try {
            ...
            if (createDidDataResult != null) {
                ...
                ResponseData<Cpt> responseQryCpt = cptService.queryCpt(cptId);
                if(String.valueOf(ErrorCode.CPT_NOT_EXISTS.getCode()).equals(responseQryCpt.getErrorCode())
                        || ErrorCode.CPT_NOT_EXISTS.getCodeDesc().equals(responseQryCpt.getErrorMessage())){
                    // registerAuthorityIssuer
                    AuthorityIssuer authorityIssuer = new AuthorityIssuer();
                    authorityIssuer.setDid(createDidDataResult.getDid());
                    authorityIssuer.setName("icbc668");
                    authorityIssuer.setAccValue("9999");
                    ...
                    ResponseData<Boolean> responseRegAuthorityIssuer = authorityIssuerService.registerAuthorityIssuer(registerAuthorityIssuerArgs);

                    // registerCpt
                    String jsonSchema = "{\"properties\" : {\"name\": {\"type\": \"string\",\"description\": \"the name of certificate owner\"}, \"identityCard\": {\"type\": \"string\",\"description\": \"the identityCard of certificate owner\"}, \"bank\": {\"type\": \"string\", \"description\": \"the bank of certificate owner\"}, \"papersName\": {\"type\": \"string\", \"description\": \"the papersName of credential\"}},\"required\": [\"name\", \"identityCard\", \"bank\", \"papersName\"]}";

                    DidAuthentication didAuthentication = new DidAuthentication();
                    didAuthentication.setDid(createDidDataResult.getDid());
                    ...
                    ResponseData<CptBaseInfo> responseRegCpt = cptService.registerCpt(cptStringArgs, cptId);
                }
