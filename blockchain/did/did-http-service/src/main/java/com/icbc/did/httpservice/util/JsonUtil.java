...
import com.icbc.did.core.exception.DataTypeCastException;
...
public class JsonUtil {
     ...
     * @return Object List
     */
    public static List<Object> jsonStrToObjs(Object obj, String jsonStr) {
        try {
            return OBJECT_MAPPER.readValue(jsonStr, OBJECT_MAPPER.getTypeFactory().constructCollectionType(List.class, obj.getClass()));
        } catch (IOException e) {
            throw new DataTypeCastException(e);
        }
    }
